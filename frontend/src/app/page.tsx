      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          {authMounted && authUser ? (
            <>
              <Link href='/whats-new' style={{ color: '#94a3b8', fontSize: 14, textDecoration: 'none' }}>
            ...
            <>
              ...
              <Link href='/whats-new' style={{ color: '#94a3b8', fontSize: 14, textDecoration: 'none' }}>{t('land_nav_whats_new')}</Link>
